package com.example.abner.slidelistview.slidelistview.wrap;
...
import com.example.abner.slidelistview.R;
import com.example.abner.slidelistview.slidelistview.SlideListView;
import com.example.abner.slidelistview.slidelistview.SlideListView.SlideMode;
import com.example.abner.slidelistview.slidelistview.SlideListView.SlideAction;
...
public class SlideItemWrapLayout extends RelativeLayout {
	...
	public interface ScrollDeleteCallBack{
		void onDelete(SlideItemWrapLayout v);
	}

	private ScrollDeleteCallBack mScrollDeleteCallBack;

	public void setScrollDeleteCallBack(ScrollDeleteCallBack mScrollDeleteCallBack) {
		this.mScrollDeleteCallBack = mScrollDeleteCallBack;
	}

	public ScrollDeleteCallBack getScrollDeleteCallBack() {
		return mScrollDeleteCallBack;
	}
