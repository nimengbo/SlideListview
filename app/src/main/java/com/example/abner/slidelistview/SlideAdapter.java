package com.example.abner.slidelistview;
...
import com.example.abner.slidelistview.slidelistview.SlideBaseAdapter;
...
//		return R.layout.row_right_back_view;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView instanceof SlideItemWrapLayout) {
            ((SlideItemWrapLayout) convertView).setScrollDeleteCallBack(new SlideItemWrapLayout.ScrollDeleteCallBack() {
                @Override
                public void onDelete(final SlideItemWrapLayout v) {
